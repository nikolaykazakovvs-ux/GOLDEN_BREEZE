...
class V4Config:
    ...
    - input_channels: Number of OHLCV features (5)
    
    SMC Features:
    - static_smc_dim: Dimension of static SMC features (bias, trend, etc.)
    - dynamic_smc_dim: Dimension of dynamic SMC events (OB, FVG, etc.)
    - max_dynamic_tokens: Maximum number of dynamic SMC tokens
    ...
    # === SMC Features ===
    static_smc_dim: int = 16
    dynamic_smc_dim: int = 16
